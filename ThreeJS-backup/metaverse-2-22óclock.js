// const { CubeTexture } = require("../three.min");
...
var models = {
	B3: {
		glb:"ThreeJS/models/gltf/B3.glb",
		mesh: null
	},
	B5: {
...
function onResourcesLoaded(){
	...
	meshes["B3"] = models.B3.mesh.clone();
	meshes["B5"] = models.B5.mesh.clone();
	meshes["B6"] = models.B6.mesh.clone();
	
	// Reposition individual meshes, then add meshes to scene
	meshes["B3"].position.set(-5, 0, 4);
	meshes["B3"].scale.set(5, 5, 5);


	console.log(meshes["B3"]);
